...
#MutantHunter rewrite from SupFinder script by Mitch Ellison

#MutantHunter Runcode

# cd /Users/mitchellellison/Desktop/Analysis_Directory.tmp/MutantHunter-master/MutantHunter_Code
# 
